...
public class UserRoleDaoImpl implements UserRoleDao {
	...
	private static final String UPDATE_USER_ROLE="UPDATE user_role SET role = ?,role_info=? WHERE id_user=?";
	private static final String DELETE_USER_ROLE="DELETE FROM user_role WHERE role=?";
